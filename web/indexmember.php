				...
				<div class="agileinfo-ads-display col-lg-12">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-Bold">Product Recomendation</h3>
							<div class="row">
							<?php
						...
						$halaman = 9;
 						 $page = isset($_GET["halaman"]) ? (int)$_GET["halaman"] : 1;
							...
							$query = mysql_query("SELECT * FROM tbl_produk where stok > 0 order by id_produk desc limit 9");
							$total =mysql_num_rows($query);
							$pages = ceil($total/$halaman);
							$res = mysql_query("SELECT * FROM tbl_produk where stok > 0 LIMIT $mulai,$halaman")or die(mysql_error);
							$no =$mulai+1;
