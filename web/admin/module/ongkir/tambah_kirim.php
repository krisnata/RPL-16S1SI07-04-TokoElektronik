...
<div class="row">
              <div class="col-md-10">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="../admin/module/ongkir/simpankir.php" method="post" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control" id="kota" type="text" name="kota" placeholder="Text">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control" id="biaya" type="text" name="biaya" placeholder="Text">
