        ...
        <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-align-justify"></i> Penjualan </div>
                  <div class="card-body">
                ...
                $no=0;
                $kueriProduk= mysql_query("select * from tbl_tagihan,tbl_member WHERE tbl_tagihan.Id_member=tbl_member.Id_member")or die(mysql_error());
                ...
                ?>
                      ...
                      <form action="<?php echo $admin_url; ?>module/produk/hapuspro.php" method="post">
                         ...
                         <form action="<?php echo $admin_url; ?>admin.php?module=detail" method="post">
                          <fieldset>
                          <input type="hidden" name="id_member" value="<?php echo $pro['Id_member']; ?>" >
                            <input type="hidden" name="id_tagihan" id="id_tagihan" value="<?php echo $pro['id_tagihan']; ?>">
                            <input type="submit" name="submit" value=" detail " class="btn btn-block btn-dark">
                          </fieldset>
                        </form>
                  </div>
                  </td>
